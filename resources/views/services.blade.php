...
<body class="bg-background-light font-display text-text-light">
    <div class="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
        <div class="layout-container flex h-full grow flex-col">
            ...
            <!-- Main Content -->
           <main>
                <section class="text-center py-16 bg-gradient-to-b from-primary/10 to-white">
                    <h1 class="text-4xl font-bold text-text-light mb-4">Our Services</h1>
                    <p class="max-w-2xl mx-auto text-text-muted-light">
                        We gather to worship, grow, and serve together as one family in Christ. Join us throughout the week for uplifting worship, prayer, and fellowship.
                    </p>
                </section>

                <section class="py-16 bg-gray-50">
                    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-12">
                        <h2 class="text-3xl font-bold text-text-light mb-3">Community & Fellowship</h2>
                        <p class="text-text-muted-light max-w-2xl mx-auto">
                        Find your place to belong — our ministries and fellowships are open to everyone.
                        </p>
                    </div>

                    <div class="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
                        <div class="group-card bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                        <span class="material-symbols-outlined text-4xl text-primary mb-3">groups</span>
                        <h3 class="text-lg font-semibold mb-2 text-text-light">Women’s Fellowship</h3>
                        <p class="text-sm text-text-muted-light mb-3">Bible study, encouragement, and friendship for women of all ages.</p>
                        <p class="text-sm text-text-muted-light"><strong>Tuesday:</strong> 10:00 AM</p>
                        </div>

                        <div class="group-card bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                        <span class="material-symbols-outlined text-4xl text-primary mb-3">music_note</span>
                        <h3 class="text-lg font-semibold mb-2 text-text-light">Music Ministry</h3>
                        <p class="text-sm text-text-muted-light mb-3">Worship through music — join our choir or band!</p>
                        <p class="text-sm text-text-muted-light"><strong>Saturday:</strong> 2:00 PM</p>
                        </div>

                        <div class="group-card bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                        <span class="material-symbols-outlined text-4xl text-primary mb-3">volunteer_activism</span>
                        <h3 class="text-lg font-semibold mb-2 text-text-light">Community Outreach</h3>
                        <p class="text-sm text-text-muted-light mb-3">Serving through compassion — food drives, visits, and service projects.</p>
                        <p class="text-sm text-text-muted-light"><strong>2nd Saturday:</strong> 9:00 AM</p>
                        </div>
                    </div>
                </section>
                <section class="py-20 bg-gradient-to-r from-primary to-secondary text-white">
                    <div class="max-w-6xl mx-auto px-4 sm:px-4 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">

                        <!-- LEFT: Intro Text -->
                        <div>
                        <h2 class="text-4xl font-bold mb-4">Plan Your Visit</h2>
                        <p class="text-white/90 mb-6">
                            We’d love to welcome you to St. John’s Parish Church Entebbe! Fill out the form to let us know when you’d like to visit — our hospitality team will be ready to receive you and make your visit meaningful.
                        </p>
                        <p class="text-white/80">
                            Whether you’re new to the community or just visiting, your presence means a lot to us. We can help arrange transport, seating, and introductions to our ministries if you wish.
                        </p>
                        </div>
                        ...
                        <form class="space-y-6">
                            ...
                            <!-- Date -->
                            <div>
                            <label for="date" class="block text-sm font-medium text-gray-700 mb-1">Preferred Visit Date</label>
