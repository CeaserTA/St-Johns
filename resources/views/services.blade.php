...
>>>>>>> bcfbee8172fef22e2a2257168e57d8898016fb83
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            @forelse($services as $index => $service)
                ...
                <div class="bg-white rounded-3xl p-6 shadow hover:shadow-xl transition-all border border-gray-100 text-center">
                    <div class="w-16 h-16 mx-auto mb-4 bg-{{ $colorClass }}/10 rounded-full flex items-center justify-center">
                        <svg class="w-10 h-10 text-{{ $colorClass }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @else
                        <div class="mt-3 pt-3 border-t border-gray-200">
                            <p class="text-xs text-gray-500 uppercase tracking-wide mb-1">Registration Fee</p>
                ...
                @else
                    ...
                    <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-xl">
                        ...
                        <div class="mt-3 flex gap-3">
                            ...
                            <a href="#" onclick="showQuickAccountModal(); return false;" class="px-4 py-2 border-2 border-primary text-primary rounded-lg hover:bg-blue-50">
                                Create Account
                            </a>
                        </div>
                    </div>
    ...
    <div class="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div class="p-8">
            ...
            <div class="flex justify-between items-start mb-6">
                ...
                <button onclick="closePaymentModal()" class="text-gray-400 hover:text-gray-600 text-3xl leading-none">&times;</button>
            </div>
            ...
            <div class="bg-gray-50 rounded-xl p-4 mb-6">
                ...
                <div class="space-y-1 text-sm">
                    ...
                    <p><span class="font-medium">Fee:</span> <span id="modal-service-fee" class="text-secondary font-bold"></span></p>
                    <p><span class="font-medium">Registration ID:</span> <span id="modal-registration-id" class="font-mono"></span></p>
                </div>
            </div>
            ...
            <form id="paymentProofForm" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="payment_method" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-secondary focus:ring-4 focus:ring-secondary/10 transition">
                ...
                <div>
                    ...
                    <input type="text" name="transaction_reference" required placeholder="e.g., MTN123456789 or Bank Ref" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-secondary focus:ring-4 focus:ring-secondary/10 transition">
                    <p class="text-xs text-gray-500 mt-1">Enter the transaction ID from your mobile money or bank receipt</p>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Additional Notes (Optional)</label>
                    <textarea name="payment_notes" rows="2" placeholder="Any additional information..." class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-secondary focus:ring-4 focus:ring-secondary/10 transition"></textarea>
                </div>

                <div class="flex gap-3 pt-4">
                    <button type="submit" class="flex-1 bg-secondary hover:bg-red-700 text-white font-bold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                        Submit
                    </button>
                    <button type="button" onclick="closePaymentModal()" class="px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition">
                        I'll Pay Later
                    </button>
                </div>
            </form>
            ...
            <div class="mt-6 p-4 bg-blue-50 rounded-xl">
                <p class="text-sm text-blue-800">
                    <strong>Note:</strong> Your registration is confirmed, but you need to complete payment. 
                    You can submit payment proof now or later. Our team will verify and send you a confirmation email.
                </p>
            </div>
        </div>
    </div>
