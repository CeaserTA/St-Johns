        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <header
                ...
                <div class="flex items-center gap-3 sm:gap-6 flex-1 min-w-0">
                    ...
                    <div class="hidden sm:flex items-center flex-1 max-w-md" x-data="globalSearch()">
                        <div class="w-full relative">
                            <input type="text" 
                                   ...
                                   placeholder="Search members, events, givings..."
                                class="w-full pl-5 pr-12 py-3 rounded-xl border border-gray-200 focus:border-accent focus:ring-4 focus:ring-accent/20 bg-white dark:bg-gray-800 text-primary dark:text-text-dark placeholder-gray-500 dark:placeholder-gray-400 text-base transition-all duration-200 shadow-sm hover:shadow" />
                            <button type="button"
                                    @click="performSearch()"
                            ...
                            <div x-show="showResults && (searchQuery.length >= 2 || loading)"
                                 x-cloak
                                 ...
                                 class="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 max-h-96 overflow-y-auto z-50">
                                ...
                                <!-- Results -->
                                <div x-show="!loading && searchQuery.length >= 2">
                                    <!-- No Results -->
                                    <div x-show="totalResults === 0" class="p-8 text-center text-gray-500 dark:text-gray-400">
                                    ...
                                    <!-- Members -->
                                    <div x-show="results.members && results.members.length > 0" class="border-b border-gray-100 dark:border-gray-700">
                                        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-900 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">
                                            Members
                                        </div>
                                    ...
                                    <!-- Events -->
                                    <div x-show="results.events && results.events.length > 0" class="border-b border-gray-100 dark:border-gray-700">
                                        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-900 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">
                                            Events
                                        </div>
                                    ...
                                    <!-- Services -->
                                    <div x-show="results.services && results.services.length > 0" class="border-b border-gray-100 dark:border-gray-700">
                                        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-900 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">
                                            Services
                                        </div>
                                        <template x-for="item in results.services" :key="item.id">
                                            <a :href="item.url" 
                                               class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    ...
                                    <!-- Givings -->
                                    <div x-show="results.givings && results.givings.length > 0" class="border-b border-gray-100 dark:border-gray-700">
                                        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-900 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">
                                            Givings
                                        </div>
                                        <template x-for="item in results.givings" :key="item.id">
                                            <a :href="item.url" 
                                               class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    ...
                                    <!-- Groups -->
                                    <div x-show="results.groups && results.groups.length > 0">
                                        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-900 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">
                                            Groups
                                        </div>
                                        <template x-for="item in results.groups" :key="item.id">
                                            <a :href="item.url" 
                                               class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
...
<div class="flex items-center gap-3 sm:gap-5 flex-shrink-0">
    ...
    <div class="relative" x-data="{ open: false }" @keydown.escape.window="open = false">
        <button @click="open = !open" 
                class="flex items-center gap-2 px-3 py-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition">
            ...
            @endif
            <span class="hidden sm:inline text-sm font-medium text-gray-700 dark:text-gray-200">{{ auth()->user()->name }}</span>
        ...
        <div x-show="open" 
            ...
            <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                ...
                <span class="inline-block mt-2 px-2 py-1 text-xs font-medium bg-primary/10 text-primary rounded-full">
            ...
            <a href="{{ route('admin.profile') }}" 
               class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
            ...
            <div class="border-t border-gray-100 dark:border-gray-700 mt-2 pt-2">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" 
                            class="flex items-center gap-3 px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition w-full text-left">
            ...
            return {
                ...
                async performSearch() {
                    ...
                    try {
                        ...
                        console.log('Results object:', this.results);
                    } catch (error) {
